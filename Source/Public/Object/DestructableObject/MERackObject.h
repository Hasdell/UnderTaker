...
#include "MERackObject.generated.h"

/**
 * 
 */
UCLASS()
class MOONEATER_API AMERackObject : public AMEDestructableObjectBase
{
	GENERATED_BODY()
public:
	AMERackObject();
...
private:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Collision", meta = (AllowPrivateAccess = true))
		class UBoxComponent* CrossBodyLeftCollision = nullptr;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Collision", meta = (AllowPrivateAccess = true))
		class UBoxComponent* CrossBodyRightCollision = nullptr;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Collision", meta = (AllowPrivateAccess = true))
